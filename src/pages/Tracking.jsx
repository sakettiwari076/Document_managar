...
const Tracking = () => {
  ...
  <div className="p-4 mt-4">
    <h1 className="text-4xl text-center font-semibold mb-6">Document status</h1>
      ...
      <div className="flex flex-col md:grid grid-cols-12 text-gray-50">
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 className="font-semibold text-lg mb-1">Document Submitted</h3>
          ...
          <div className="bg-orange-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 className="font-semibold text-lg mb-1">AI verification</h3>
            <p className="leading-tight text-justify w-full">
              21 July 2021, 04:30 PM
            </p>
          </div>
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-orange-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 className="font-semibold text-lg mb-1">Mentor Review</h3>
            <p className="leading-tight text-justify w-full">
              SOON
            </p>
          </div>
        ...
        <div className="flex md:contents">
          ...
          <div classNameName="bg-red-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 classNameName="font-semibold text-lg mb-1">Coordinator Review</h3>
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-orange-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 className="font-semibold text-lg mb-1 text-gray-50">HOD Review</h3>
            <p className="leading-tight text-justify">
              SOON
            </p>
          </div>
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-gray-300 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 className="font-semibold text-lg mb-1 text-gray-400">Approved</h3>
            <p className="leading-tight text-justify">
