...
const notify = () => setTimeout(()=>{toast("Form Submitted");},1000);

const Documentform = () => {
    
  return (
    <><Navbar /><div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
          <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full max-w-5xl	 overflow-hidden">
              <div className="md:flex w-full">
                  ...
                  <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                      <div className="text-center mb-10">
                          <h1 className="font-bold text-3xl text-gray-900">Hey, Lets begin...</h1>
                          <p>Enter your document information</p>
                      </div>
                      <div>
                          ...
                          <div className="flex -mx-3">
                              <div className="w-full px-3 mb-5">
                                  <label for="" className="text-xs font-semibold px-1">Document category</label>
                                  <div className="flex">
                                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                      <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Sick leave" />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div className="flex -mx-3">
                              <div className="w-full px-3 mb-12">
                                  <label for="" className="text-xs font-semibold px-1">Date of Requirement</label>
                                  <div className="flex">
                          ...
                          <div className="flex -mx-3">
                              <div className="w-full px-3 mb-12">
                                  <label for="" className="text-xs font-semibold px-1">Reason</label>
                                  <div className="flex">
                                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                      <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                  </div>
                          ...
                          <div className="flex -mx-3">
                              <div className="w-full px-3 mb-12">
                                  ...
                                  <label className="block mb-2   text-gray-900 text-xs font-semibold px-1 " for="multiple_files">Upload Document</label>
                                  <div className="flex">
                          ...
                          <div className="flex -mx-3">
                              <div className="w-full px-3 mb-5">
                                  <Link to="/documentataion123/tracking">
                                      <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"  onClick={notify} >Submit</button>
                                      <ToastContainer />
